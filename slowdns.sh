#!/bin/bash
# ZAW SLOWDNS (DNSTT) AUTO INSTALLER
...
# Dropbear ကို Local Port 109 တွင် ဖွင့်ပေးခြင်း (SlowDNS က ဒီကနေတစ်ဆင့် ဖောက်ထွက်မည်)
...
# Precompiled DNSTT server ကို ဒေါင်းလုဒ်ဆွဲခြင်း
...
# Port 53 UDP လမ်းကြောင်း ဖွင့်ခြင်း
...
wget -qO /usr/bin/smenu "https://raw.githubusercontent.com/zaw-myscript/-my-zivpn/main/smenu"
